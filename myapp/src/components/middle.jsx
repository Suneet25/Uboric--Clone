    ...
    <div>
      <div className="container" style={container}>
        <div className="imgs">
          <img
            ...
            src="https://outstripinfotech.com/wpword/razi/wp-content/uploads/2022/08/kithchen-tools.jpg"
          />
        </div>
        <div className="imgs">
          <img
            style={{ height: "300px", width: "425px" }}
            src="https://outstripinfotech.com/wpword/razi/wp-content/uploads/2022/08/Air-Tight-Containers.jpg"
          />
        </div>
        <div className="imgs">
          <img
            style={{ height: "300px", width: "425px" }}
            src="https://www.uboric.com/wp-content/uploads/2022/08/81UV5oidWoL._SL1500_.jpg"
          />
        </div>
      </div>
      ...
      >
        <div style={{ marginLeft: "100px" }}>
          <FaAngleLeft
            style={{ width: "42px", height: "42px", color: "#a0a0a0" }}
          />
        </div>
      ...
      >
        <div style={{ position: "relative" }}>
          <div>
            <img
              src="https://www.uboric.com/wp-content/uploads/2022/08/banner2-1.jpg"
        ...
        <div style={{ position: "relative" }}>
          <div>
            <img
              src="https://www.uboric.com/wp-content/uploads/2022/08/banner1-1-1.jpg"
              style={{ width: "100%", display: "block" }}
            />
          </div>
          <div
        ...
        <div style={{ position: "relative" }}>
          <div>
            <img
              src="https://www.uboric.com/wp-content/uploads/2022/08/banner3-1.jpg"
              style={{ width: "100%", display: "block" }}
            />
          </div>
          <div
      ...
      >
        <div>
          <img
            src="	https://www.uboric.com/wp-content/uploads/2022/08/photo_2022-02-24_12-22-08-370x370.jpg"
            width="100%"
          />
          <p>
            <b>Quick And Easy 6 Blade Push Chopper 1000ML</b>
          </p>
          <p>
            <s style={{ color: "#a0a0a0" }}>₹799.00</s>{" "}
            <b style={{ color: "#ff6f61" }}>₹349.00</b>
          </p>
        </div>
        <div>
          <img
            src="	https://www.uboric.com/wp-content/uploads/2022/08/51it7ZuoqBL-370x370.jpg"
            width="100%"
          />
          <p>
            <b>Quick And Easy 6 Blade Push Chopper 1000ML</b>
        ...
        <div>
          <img
            src="	https://www.uboric.com/wp-content/uploads/2022/08/51ttBYWqRL-1-370x370.jpg"
            width="100%"
          />
          <p>
            <b>Quick And Easy 6 Blade Push Chopper 1000ML</b>
      ...
      >
        <div style={{ width: "300px" }}>
          <img
            src="https://www.uboric.com/wp-content/uploads/2022/11/CHRLEISURE-Women-Winter-Thicken-Leggings-Warm-Fleece-Pants-Female-Thermal-Leggins-7.jpg"
            width="100%"
          />
          <p>
            <b>Quick And Easy 6 Blade Push Chopper 1000ML</b>
        ...
        <div style={{ width: "300px" }}>
          <img
            src="https://www.uboric.com/wp-content/uploads/2022/11/data-1.png"
            width="100%"
          />
          <p>
            <b>Quick And Easy 6 Blade Push Chopper 1000ML</b>
        ...
        <div style={{ width: "300px" }}>
          <img
            src="	https://www.uboric.com/wp-content/uploads/2022/11/582242287493316608.jpg"
            width="100%"
          />
          <p>
            <b>Quick And Easy 6 Blade Push Chopper 1000ML</b>
        ...
        <div style={{ width: "300px" }}>
          <img
            src="https://www.uboric.com/wp-content/uploads/2022/11/Car-Phone-Holder-Multifunctional-360-Degree-Rotatable-Auto-Rearview-Mirror-Seat-Hanging-Clip-Bracket-Cell-Phone-1.jpg"
            width="100%"
          />
          <p>
            <b>Men's Casual Shoes</b>
          </p>
          <p>
            <s style={{ color: "#a0a0a0" }}>₹799.00</s>{" "}
            <b style={{ color: "#ff6f61" }}>₹349.00</b>
        ...
        <div style={{ width: "300px" }}>
          <img
            src="https://www.uboric.com/wp-content/uploads/2022/11/ILIFE-V7s-Plus-Robot-Vacuum-Cleaner-Sweep-and-Wet-Mopping-Floors-Carpet-Run-120mins-Auto-Reharge.jpg"
            width="100%"
          />
          <p>
            <b>Men's Casual Shoes</b>
          ...
          <p>
            <s style={{ color: "#a0a0a0" }}>₹2,079.00</s>{" "}
            <b style={{ color: "#ff6f61" }}>₹1,039.00</b>
          </p>
        </div>
        <div style={{ width: "300px" }}>
          <img
      ...
      >
        <div style={{ width: "50%" }}>
          <h1 style={{ textAlign: "left", marginLeft: "40px" }}>
        ...
        <div style={{ width: "50%" }}>
          <img
            src="https://www.uboric.com/wp-content/uploads/2022/08/61OR0aPLJAL._SL1500_-768x659.jpg"
            width="100%"
            display="block"
          />
        </div>
